...
const TestDriveForm = ({ children }: TestDriveFormProps) => {
    ...
    const form = useForm<z.infer<typeof AppointmentSchema>>({
        ...
        defaultValues: {
            ...
            phone: "+32",
            message:
                "Hi, I would like to make an appointment for a test drive with this vehicle.",
        },
    });
    ...
    return (
        <Sheet>
            ...
            <SheetContent className="w-full max-w-full sm:max-w-[540px] md:max-w-[640px] lg:max-w-[720px] overflow-y-auto">
                <SheetHeader>
                    <SheetTitle>Ask for test drive</SheetTitle>
                    <SheetDescription>
                        Please fill the form below to ask for a test drive with
                        this vehicle.
                    </SheetDescription>
                </SheetHeader>
                <div className="mt-4">
