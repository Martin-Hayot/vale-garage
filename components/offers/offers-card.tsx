...
const OffersCard = () => {
    return (
        <div className="bg-neutral-800 rounded-xl flex flex-col w-72">
            <div className="relative">
                ...
                <div className="bg-neutral-700/50 rounded-full p-2 absolute z-10 top-3 right-3 flex flex-row gap-x-2">
                    ...
                    <Fuel className="w-4 h-4 text-violet-300" />
                </div>
                <Image
            ...
            <div className="p-3 flex flex-col md:flex-row md:justify-between md:items-center gap-y-1 ">
                <div>
                    <h3 className="font-bold text-sm">Ford F-150</h3>
                    <p className="text-neutral-500 text-xs">2021, 5000 km</p>
                </div>
